...
Route::get('ads/share', 'AjaxController@shareAd')->name('shareAd');
Route::get('ads/view/count/{id}', 'AjaxController@adViewCount')->name('adViewCount');
Route::get('serach/keyword/store/{id}', 'SearchHistoryController@store')->name('storeSearchKeyword');
