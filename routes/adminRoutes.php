...
Route::group(['middleware' => ['auth:admin', 'admin']], function(){
	...
	Route::get("image/delete", "AjaxController@imageDelete")->name("admin.imageDelete");

	Route::get('serach/keyword/list', 'SearchHistoryController@list')->name('searchKeywordList');
	Route::get('serach/keyword/delete/{id}', 'SearchHistoryController@delete')->name('searchKeywordDelete');
	...
	// model routes 
	 ...
	 Route::post('post/brandmodel/update', 'BrandController@brandmodel_update')->name('brandmodel.update');
	 Route::get('post/brandmodel/delete/{id}', 'BrandController@brandmodel_delete')->name('brandmodel.delete');
	...
	Route::post('affiliate/update', 'AffiliateController@affiliateCodeUpdate')->name('affiliateCodeUpdate');
	Route::get('affiliate/delete/{id}', 'AffiliateController@affiliateCodeDelete')->name('affiliateCodeDelete');
	Route::get('affiliate/sellers/{code}', 'AffiliateController@affiliateSellers')->name('affiliateSellers');
	

	Route::get('affiliate/discount', 'AffiliateDiscountController@index')->name('affiliateDiscount');
	Route::post('affiliate/discount/store', 'AffiliateDiscountController@store')->name('affiliateDiscountStore');
	Route::get('affiliate/discount/edit/{id}', 'AffiliateDiscountController@edit')->name('affiliateDiscountEdit');
	Route::post('affiliate/discount/update', 'AffiliateDiscountController@update')->name('affiliateDiscountUpdate');
	Route::get('affiliate/discount/delete/{id}', 'AffiliateDiscountController@delete')->name('affiliateDiscountDelete');
...
Route::group(['middleware' => 'auth:admin', 'namespace' => 'Admin'], function(){
	...
	Route::get('membership/user', 'MembershipController@allMembership')->name('allMembership');
	Route::get('membership/request/list', 'MembershipController@membershipRequests')->name('membershipRequests');
	Route::get('membership/invoice/{id}', 'MembershipController@membershipInvoice')->name('admin.membershipInvoice');
