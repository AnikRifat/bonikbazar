...
<div class="col-md-12">
    <div class="form-group"> 
        ...
        <input data-default-file="{{asset('upload/images/brand/thumb/'.$data->logo)}}" type="file" class="dropify" accept="image/*" data-type='image' data-allowed-file-extensions="jpg png gif"  data-max-file-size="2M"  name="phato" id="input-file-events">
