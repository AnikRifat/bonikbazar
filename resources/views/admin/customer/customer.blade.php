                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="item{{$customer->id}}">
                                            ...
                                            <td> @if($customer->sellerVerify && $customer->sellerVerify->status == "active") <span style="color:green"> Verified </span>@elseif($customer->sellerVerify && $customer->sellerVerify->status == 'pending') <span style="color:blue">{{$customer->sellerVerify->status}}</span> @elseif($customer->sellerVerify) <span style="color:red">{{$customer->sellerVerify->status}}</span> @else <span style="color:green">Unverify</span> @endif</td>
                                            <td>
