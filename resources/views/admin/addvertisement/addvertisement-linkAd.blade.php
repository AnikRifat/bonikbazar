...
<div style="margin:0 10px;" class="row">
    ...
    <div class="col-8">
        ...
        <div class="col-6">
            ...
            <input type="date" required  value="{{Carbon\Carbon::parse($data->start_date)->format('Y-m-d')}}" name="start_date" id="start_date" class="mt-2 w-100 borders p-2 gb shadow-b rounded-3">
        </div>
        <div class="col-6">

            <label for="">End date</label>
            <input type="date" required min="{{Carbon\Carbon::parse(now())->format('Y-m-d')}}" value="{{Carbon\Carbon::parse($data->end_date)->format('Y-m-d')}}" name="end_date" id="end_date" class="mt-2 w-100 borders p-2 gb shadow-b rounded-3">
        </div>
        </div>
    </div> 
    ...
    <div class="col-12">
        <div class="form-group">
        <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*" data-max-file-size="15M" data-default-file="{{asset('upload/marketing/'.$data->image)}}" class=" dropify shadow-b" name="desktop_image">
    ...
    <div class="col-12 col-md-6">
        ...
        <div class="h-500">
            <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*" data-max-file-size="15M" data-default-file="{{asset('upload/marketing/'.$data->sideAd_image)}}" class=" dropify mt-2 shadow-b" name="sideAd_image">
    ...
    <div class="col-12 col-md-6">
        ...
        <div>
            <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*" data-max-file-size="5M" data-default-file="{{asset('upload/marketing/'.$data->mobile_image)}}" class=" dropify mt-2 shadow-b" name="mobile_image">
