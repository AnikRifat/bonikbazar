            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <a class="btn btn-info btn-sm d-none d-lg-block m-l-15" href="{{ route('admin.packageList') }}"><i class="fa fa-eye"></i> Boost Package lists</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                                    ...
                                    @if(count($packages)>0)
                                        ...
                                        <tr id="{{$package->package_id}}" @if($package->order_status == 'cancel') style="background:#ff000026" @endif >
                                           ...
                                           <td>{{ $package->customer_name }}
                                            ...
                                            <td>
                                                @if($package->get_boostAd)
                                                <a target="_blank" href="{{ route('post_details', $package->get_boostAd->slug) }}"> {{Str::limit($package->get_boostAd->title, 40)}}</a> <br/>
                                                @endif
                                            ...
                                            <td>
                                                {{$package->currency_sign}}{{$package->total_price }}
                                            ...
                                            <td><a href="{{ route('admin.packageInvoice', $package->order_id) }}"><i class="fa fa-print"> Invoice </a></td>
                                            <td>
                                                 
                                                <a href="javascript:void(0)" class="label @if($package->payment_status == 'paid')  label-success @elseif($package->payment_status == 'received') label-info @else label-danger @endif">
                                                
                                                <span class="mytooltip tooltip-effect-2">
                                                <div @if($permission['is_edit'])  onclick="orderPaymentPopup('{{ route("packagePaymentDetails", $package->order_id)}}')" @endif  title="package payment info" data-toggle="tooltip"  class="text-inverse p-r-10" >{{$package->payment_status}} </div>
                                                </span>
                                                </a>
