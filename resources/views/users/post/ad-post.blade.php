    ...
    <div class="container bg-white mb-2 py-3 px-0">
        ...
        <div class="row">
            <div class="col-12 border-b">
                ...
                <img width="20" class=" mr-2" src="{{ asset('upload/images/m-1.png')}}"> {{$category->name}} <span class="changeBtn">Change</span></a></div>
                <a href="javascript:void(0)" data-toggle="modal" data-target="#locationmodal">
                <img width="20" class=" mr-1" src="{{ asset('upload/images/m-2.png')}}"> {{$location->name}}@if($location->state), {{$location->state->name}} @endif <span class="changeBtn">Change</span></a>
                </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-7 pt-3 border-rr">
                ...
                <div class="form-group">
                    ...
                    <input name="title" value="{{ old('title') }}" required type="text" class="form-control" placeholder="Type your title here">
                </div>
            ...
            <div class="col-12 col-md-5 pt-3">
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="price" value="{{ old('price') }}" required class="form-control borders" placeholder="Enter your price" aria-label="Username" aria-describedby="basic-addon1">
                    ...
                    <ul class="product-widget-list">
                        ...
                        <li class="product-widget-dropitem" style="margin: 0;padding: 8px; border-bottom: 1px solid #f1f1f1;">
                            ...
                            <ul class="product-widget-dropdown" >
                                ...
                                <li><a href="{{ route('post.categoryChange', [$post->id, $subcategory->id]) }}"> {{$subcategory->name}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        @endforeach
                    ...
                    <ul class="product-widget-list">
                        ...
                        <li class="product-widget-dropitem" style="margin: 0;padding: 8px; border-bottom: 1px solid #f1f1f1;">
                            ...
                            <ul class="product-widget-dropdown">
                                ...
                                <li><a href="{{ route('post.locationChange', [$post->id, $city->id]) }}"> {{$city->name}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        @endforeach
