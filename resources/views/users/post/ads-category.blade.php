    ...
    <div id="box2" class="box w-100 py-3" style="display: none;">
        ...
        <div class="row mmm">
            ...
            <div class="col-12 col-md-8">
                ...
                <div class="col-12">
                 ...
                 <div class="col-6">
                    ...
                    <input type="date" required min="{{date('Y-m-d')}}" name="start_date" id="start_date" class="mt-2 w-100 borders p-2 gb shadow-b rounded-3">
                </div>
                <div class="col-6">

                    <label for="">End date</label>
                    <input type="date" required min="{{Carbon\Carbon::parse(now())->addDay()->format('Y-m-d')}}" name="end_date" id="end_date" class="mt-2 w-100 borders p-2 gb shadow-b rounded-3">
                </div>
                </div>
            </div> 
            ...
            <div class="col-6">
                ...
                <option value="" selected disabled>Select an option</option>
                    <option value="top" {{ (old('position') == 'top') ? 'selected' : '' }}>Banner for desktop (Top view)</option>
                    <option value="bottom" {{ (old('position') == 'bottom') ? 'selected' : '' }}>Banner for desktop (Bottom view)</option>
                </select>
                </div>
            </div>
            <div class="col-12">
            ...
            <div class="col-12 col-md-6">
                ...
                <select name="sideAd_position" class="form-control mb-2 gb shadow-b borders" id="desktop_sideAds">
                    <option value="" selected disabled>Select an option</option>
                    <option data-width="240" data-height="600" value="leftSide" {{ (old('position') == 'leftSide') ? 'selected' : '' }}>Left Sidebar</option>
                    <option data-width="160" data-height="600" value="rightSide" {{ (old('position') == 'rightSide') ? 'selected' : '' }}>Right Sidebar</option>
                </select>
