...
.user-f .follow {
    background: url('{{ asset('upload/images/white-btn.svg')}}');
    padding: 5px 8px 5px 25px;
    background-repeat: no-repeat;
}
.user-f .followy {
    background: url('{{ asset('upload/images/yellow-btn.svg')}}');
    padding: 5px 8px 5px 25px;
    background-repeat: no-repeat;
}
.text-red {
    ...
    <div class="row">
        <div class="container px-0">
            <div class="row align-items-center">
                ...
                <div class="col-md-7">
                    <form action="{{ route('home.category', [ (Request::route('location') ? Request::route('location') : 'all'), (Request::route('catslug') ? Request::route('catslug') : null) ])}}" method="get" id="searchForm" class="w-100 d-flex align-items-center bb2 rounded e6"> 
                        <input type="text" id="searchKey" value="{{ Request::get('q') }}" name="q" class="searchKey w-100 p-2 rounded-l" placeholder="What are you looking for?">
                    ...
                    <div class="d-flex justify-content-end flex-column">
                        <div class="d-flex justify-content-end py-2 icon-size">
                            <ul class="d-flex justify-content-end">
                                <li class="mr-3">
                                    <a href="{{url('lang')}}/{{ (Config::get('app.locale') == 'en') ? 'bd' : 'en'}}" type="button" class="border-r pr-2">
                                ...
                                @endif
                                class="mr-3">
                                    <a href="{{route('user.message')}}" class="border-r pr-2">
    ...
    <div class="container bg-dark mb-2 position-fixed top-0">
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{url('/')}}" class="py-1">
                <img class="mw-100" height="40" src="{{ asset('upload/images/mlogo.png')}}" alt="logo">
            </a>
            <div>
                <a href="{{url('lang')}}/{{ (Config::get('app.locale') == 'en') ? 'bd' : 'en'}}" type="button" class="border-r pr-2">
                    <img width="25" height="25" src="{{ asset('upload/images/Language.png')}}" alt="logo">
                ...
                <button type="button" id="openModalBtn">
                  <img width="35" height="30" class="pl-2" src="{{ asset('upload/images/search.png')}}" alt="search">
                </button>
...
<nav class="mobile-nav">
    <div class="container">
        <div class="mobile-group">
            ...
            <a href="{{route('user.message')}}" class="mobile-widget">
