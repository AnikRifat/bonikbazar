...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo e(Request::get('name')); ?>"
                                                    placeholder="Customer name or mobile or email" name="name"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control">
                                                    <option value="all"
                                                        <?php echo e(Request::get('status') == 'all' ? 'selected' : ''); ?>>All Status
                                                    </option>
                                                    <option value="pending"
                                                        <?php echo e(Request::get('status') == 'pending' ? 'selected' : ''); ?>>
                                                        Pending</option>
                                                    <option value="active"
                                                        <?php echo e(Request::get('status') == 'active' ? 'selected' : ''); ?>>Active
                                                    </option>
                                                    <option value="deactive"
                                                        <?php echo e(Request::get('status') == 'deactive' ? 'selected' : ''); ?>>
                                                        Deactive</option>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="item<?php echo e($customer->id); ?>">
                                                <td><?php echo e($customers->perPage() * $customers->currentPage() - $customers->perPage() + ($index + 1)); ?>

                                                </td>
                                                <td><?php echo e($customer->seller_id); ?></td>
                                                <td><img src="<?php echo e(asset('upload/users')); ?>/<?php echo e($customer->photo ? $customer->photo : 'default.png'); ?>"
                                                        width="40"> <?php echo e($customer->name); ?>

                                                    <p><?php echo e(\Carbon\Carbon::parse($customer->created_at)->format(Config::get('siteSetting.date_format'))); ?>

                                                    </p>
                                                </td>
                                                <td><?php echo e($customer->mobile); ?></td>
                                                <td><?php echo e($customer->email); ?></td>
                                                <td><a href="<?php echo e(route('customer.profile', $customer->username)); ?>"
                                                        class="label label-info"><?php echo e($customer->posts_count); ?></a></td>
                                                <td><?php echo e($customer->clientIp); ?></td>

                                                <td>
                                                    <?php if($customer->sellerVerify && $customer->sellerVerify->status == 'active'): ?>
                                                        <span style="color:green"> Verified </span>
                                                    <?php elseif($customer->sellerVerify && $customer->sellerVerify->status == 'pending'): ?>
                                                        <span
                                                            style="color:blue"><?php echo e($customer->sellerVerify->status); ?></span>
                                                    <?php elseif($customer->sellerVerify): ?>
                                                        <span
                                                            style="color:red"><?php echo e($customer->sellerVerify->status); ?></span>
                                                    <?php else: ?>
                                                        <span style="color:green">Unverify</span>
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge 
                                                            <?php if($customer->membership == 'agent'): ?> badge-success 
                                                            <?php elseif($customer->membership == 'authentic'): ?> 
                                                                badge-primary 
                                                            <?php elseif($customer->membership == 'verified'): ?> 
                                                                badge-warning 
                                                            <?php elseif($customer->membership == 'wholesale'): ?> 
                                                                badge-info <?php endif; ?>">
                                                        <?php echo e($customer->membership); ?>
                                                ...
                                                <td>
                                                    <span style="cursor:pointer;"
                                                        class="label <?php if($customer->status == 'active'): ?> label-success <?php elseif($customer->status == 'band'): ?> label-danger <?php elseif($customer->status == 'deactive'): ?> label-warning <?php else: ?> label-info <?php endif; ?>"
                                                        title="customer Status (pending, active, deactive)"
                                                        <?php if($permission['is_edit']): ?> onclick="customerStatus(<?php echo e($customer->id); ?>)" <?php endif; ?>>
                                                        <?php echo e($customer->status); ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" title="View Customer Profile"
                                                                data-toggle="tooltip"
                                                                href="<?php echo e(route('customer.profile', $customer->username)); ?>"><i
                                                                    class="ti-eye"></i> View Profile</a>

                                                            <?php if($customer->membership!=null): ?>
                                                                <a class="dropdown-item" target="_blank"
                                                                    title="view membership details"
                                                                    data-toggle="tooltip"
                                                                     href="<?php echo e(route('admin.membershipInvoice', $customer->sellerMembership->id)); ?>"><i
                                                                        class="ti-eye"></i> View Membership</a>
                                                            <?php endif; ?>

                                                            <?php if($permission['is_edit']): ?>
                                                                <a class="dropdown-item" target="_blank"
                                                                    title="Secret login in the customer pannel"
                                                                    data-toggle="tooltip"
                                                                    href="<?php echo e(route('admin.customerSecretLogin', encrypt($customer->id))); ?>"><i
                                                                        class="ti-lock"></i> Customer panel</a>
                                                            <?php endif; ?>
                                                            ...
                                                            <?php if($permission['is_delete']): ?>
                                                                <span title="Delete" data-toggle="tooltip"><button
                                                                        data-target="#delete"
                                                                        onclick='deleteConfirmPopup("<?php echo e(route('customer.delete', $customer->id)); ?>")'
                                                                        data-toggle="modal" class="dropdown-item"><i
                                                                            class="ti-trash"></i> Delete
                                                                        Customer</button></span>
                                                            <?php endif; ?>
                                                            <?php if($permission['is_edit']): ?>
                                                                <button title="Password Reset" data-toggle="tooltip"
                                                                    onclick='PasswordReset("<?php echo e($customer->id); ?>")'
                                                                    class="dropdown-item"><i class="fa fa-retweet"></i>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 text-right">Showing <?php echo e($customers->firstItem()); ?> to
                    <?php echo e($customers->lastItem()); ?> of total <?php echo e($customers->total()); ?> entries (<?php echo e($customers->lastPage()); ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-row">
                    <div class="card-body">
                        <form action="<?php echo e(route('customer.store')); ?>" enctype="multipart/form-data" method="POST"
    ...
    <div class="modal fade" id="PasswordReset" role="dialog" tabindex="-1" aria-hidden="true"
        style="display: none;">
        <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="col-md-12">
                            ...
                            <input type="text" required id="password" name="password" placeholder="Enter password"
                                class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BonikBazar\bonikbazar\resources\views/admin/customer/customer.blade.php ENDPATH**/ ?>