        ...
        <div class="container-fluid">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $allMemberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <?php if($customer->user): ?>
                                        <tr id="item<?php echo e($customer->id); ?>">
                                            <td><?php echo e((($allMemberships->perPage() * $allMemberships->currentPage() - $allMemberships->perPage()) + ($index+1) )); ?></td>
                                            
                                            <td>
                                               
                                                <a  title="View Profile" href="<?php echo e(route('customer.profile', $customer->user->username)); ?>">
                                            ...
                                            <td><?php echo e(str_replace("-", " ", ucfirst($customer->membership))); ?> </td>
                                             <td>Start: <?php echo e(Carbon\Carbon::parse($customer->start_date)->format("d M, Y")); ?> <br/>
                                            ...
                                            <td><?php if($customer->sellerVerify->status == 'active'): ?><span style="color:green"> User Verified </span> <?php else: ?> <span style="color:red"> User Not Verified <?php endif; ?> </span></td>
                                            <td><a href="<?php echo e(route('admin.membershipInvoice', $customer->id)); ?>"><i class="fa fa-print"> Invoice </a></td>
                                            <td  style="cursor:pointer;" onclick="customerStatus(<?php echo e($customer->id); ?>)"> <?php if($customer->status == 'active'): ?> <span class="label label-success"> Active </span> <?php else: ?> <span class="label label-danger"><?php echo e($customer->status); ?></span> <?php endif; ?></td>
            ...
            <div class="row">
               <div class="col-sm-6 col-md-6 col-lg-6 text-center">
                   <?php echo e($allMemberships->appends(request()->query())->links()); ?>

                  </div>
                <div class="col-sm-6 col-md-6 col-lg-6 text-right">Showing <?php echo e($allMemberships->firstItem()); ?> to <?php echo e($allMemberships->lastItem()); ?> of total <?php echo e($allMemberships->total()); ?> entries (<?php echo e($allMemberships->lastPage()); ?> Pages)</div>
            </div>
            <!-- ============================================================== -->
            <!-- End PAge Content -->
            <!-- ============================================================== -->
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/admin/membership/allMemberships.blade.php ENDPATH**/ ?>