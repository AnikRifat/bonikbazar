...
<div style="margin:0 10px;" class="row">
    ...
    <div class="col-8">
        <div class="row">
            <div class="col-12">
                ...
                <input type="text" required name="redirect_url" value="<?php echo e($data->redirect_url); ?>" placeholder="link"
                    class="mb-2 w-100 borders p-2 gb shadow-b rounded-3">
            </div>
            <div class="col-6">
                <label for="">Start date</label>
                <input type="date" required value="<?php echo e(Carbon\Carbon::parse($data->start_date)->format('Y-m-d')); ?>"
                    name="start_date" id="start_date" class="mt-2 w-100 borders p-2 gb shadow-b rounded-3">
            </div>
            <div class="col-6">

                <label for="">End date</label>
                <input type="date" required min="<?php echo e(Carbon\Carbon::parse(now())->format('Y-m-d')); ?>"
                    value="<?php echo e(Carbon\Carbon::parse($data->end_date)->format('Y-m-d')); ?>" name="end_date" id="end_date"
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                ...
                <select name="desktopAd_position" required="required" id="position"
                    ...
                    <option value="top" <?php if($data->position == 'top'): ?> selected <?php endif; ?>>Banner for desktop (Top
                        view)</option>
                    <option value="bottom" <?php if($data->position == 'bottom'): ?> selected <?php endif; ?>>Banner for desktop (Bottom
                        view)</option>
                </select>
        ...
        <div class="col-6">
            <button onclick="preview('<?php echo e(asset('upload/marketing/' . $data->image)); ?>',960,250)" id="previewButton"
    ...
    <div class="col-12">
        ...
        <div class="form-group">
            ...
            <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*"
                data-max-file-size="15M" data-default-file="<?php echo e(asset('upload/marketing/' . $data->image)); ?>"
    ...
    <div class="col-12 col-md-6">
        ...
        <select name="sideAd_position" class="form-control gb shadow-b borders" id="desktop_sideAds">
            ...
            <option data-width="240" data-height="600" value="leftSide"
                <?php if($data->sideAd_position == 'leftSide'): ?> selected <?php endif; ?>>Left Sidebar</option>
            <option data-width="160" data-height="600" value="rightSide"
                <?php if($data->sideAd_position == 'rightSide'): ?> selected <?php endif; ?>>Right Sidebar</option>
        </select>
        <button onclick="preview('<?php echo e(asset('upload/marketing/' . $data->sideAd_image)); ?>',240,600)" id="previewButton"
            type="button" class="btn btn-primary my-2">
            preview
        </button>
        <div class="h-500">
            <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*"
                data-max-file-size="15M" data-default-file="<?php echo e(asset('upload/marketing/' . $data->sideAd_image)); ?>"
    ...
    <div class="col-12 col-md-6">
        ...
        <button onclick="preview('<?php echo e(asset('upload/marketing/' . $data->mobile_image)); ?>',300,300)" id="previewButton"
            type="button" class="btn btn-primary float-left my-2">
            preview
        </button>
        <div>
            <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*"
                data-max-file-size="5M" data-default-file="<?php echo e(asset('upload/marketing/' . $data->mobile_image)); ?>"
...
<?php /**PATH D:\BonikBazar\bonikbazar\resources\views/admin/addvertisement/addvertisement-linkAd.blade.php ENDPATH**/ ?>