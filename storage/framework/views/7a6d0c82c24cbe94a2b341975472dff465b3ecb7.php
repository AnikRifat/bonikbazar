...
<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php elseif($module['slug'] == 'membership'): ?>
                <?php $membershipRequest = App\Models\SellerMembership::where('payment_method', '!=', 'pending')->where("status", "pending")->count(); ?>
                <li class="modulelist module<?php echo e($module['id']); ?>">
                    <a class="has-arrow waves-effect waves-dark" href="<?php echo e(($module['route']) ? route($module['route']) : 'javascript:void(0)'); ?>" aria-expanded="false"><i class="<?php echo e($module['icon']); ?>"></i><span class="hide-menu"><?php echo e($module['module_name']); ?> <span class="badge badge-pill badge-primary text-white ml-auto"><?php echo e($membershipRequest); ?></span> </span></a>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if($role_id == 1 || ($permission && $permission['is_view'] == 1)): ?>
                        <li><a href="<?php echo e(($submodule['route']) ? route($submodule['route'], $submodule['slug']) : 'javascript:void(0)'); ?>"><?php echo e($submodule['module_name']); ?> <?php if($submodule['slug'] == "membership-request"): ?> <span class="badge badge-pill badge-primary text-white ml-auto"><?php echo e($membershipRequest); ?></span> <?php endif; ?></a></li>
                        <style type="text/css">.module<?php echo e($module['id']); ?>{display: block;}</style>
                        <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/layouts/partials/backend/admin-sidebar.blade.php ENDPATH**/ ?>