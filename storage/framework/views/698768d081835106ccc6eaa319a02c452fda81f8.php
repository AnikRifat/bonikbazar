                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="duration" required placeholder="Example: 7 Days"
                                                value="<?php echo e(old('ads')); ?>" class="form-control" type="number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="price" required
                                                ...
                                                value="<?php echo e(old('price')); ?>" class="form-control" type="number">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BonikBazar\bonikbazar\resources\views/admin/category/category.blade.php ENDPATH**/ ?>