                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="item<?php echo e($customer->id); ?>">
                                            ...
                                            <td> <?php if($customer->sellerVerify && $customer->sellerVerify->status == "active"): ?> <span style="color:green"> Verified </span><?php elseif($customer->sellerVerify && $customer->sellerVerify->status == 'pending'): ?> <span style="color:blue"><?php echo e($customer->sellerVerify->status); ?></span> <?php elseif($customer->sellerVerify): ?> <span style="color:red"><?php echo e($customer->sellerVerify->status); ?></span> <?php else: ?> <span style="color:green">Unverify</span> <?php endif; ?></td>
                                            <td>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/admin/customer/customer.blade.php ENDPATH**/ ?>