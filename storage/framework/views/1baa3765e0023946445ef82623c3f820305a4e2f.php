                                ...
                                <td class="action">
                                   <div class="status">
                                    ...
                                    <div >
                                        ...
                                        <?php else: ?>
                                        <a class="bt btn-warning btn-sm" title="Promote ads" href="<?php echo e(route('ads.promotePackage', $post->slug)); ?>" style="width: 75px;"><i class="ti-pencil-alt"></i><?php if(count($post->get_promotePackage)>0): ?> Boosted <?php else: ?> Boost Ad <?php endif; ?></a>
                                        <?php endif; ?>
                                     </div>                                    
                                </td>
                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/users/post/index.blade.php ENDPATH**/ ?>