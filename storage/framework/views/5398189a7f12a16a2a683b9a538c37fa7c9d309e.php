...
<?php $__env->startSection('title', 'Boost ads lists'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor"> Boost Ads History</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <a class="btn btn-info btn-sm d-none d-lg-block m-l-15" href="<?php echo e(route('admin.packageList')); ?>"><i class="fa fa-eye"></i> Boost Package lists</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                                ...
                                <tbody>
                                    ...
                                    <?php if(count($packages)>0): ?>
                                        ...
                                        <tr id="<?php echo e($package->package_id); ?>" <?php if($package->order_status == 'cancel'): ?> style="background:#ff000026" <?php endif; ?> >
                                            ...
                                            <td><?php echo e($package->order_id); ?>
                                           ...
                                           <?php echo e(\Carbon\Carbon::parse($package->created_at)->format('h:i:s A')); ?></p>
                                            </td>
                                           <td><?php echo e($package->customer_name); ?>
                                            ...
                                            <td>
                                                <?php if($package->get_boostAd): ?>
                                                <a target="_blank" href="<?php echo e(route('post_details', $package->get_boostAd->slug)); ?>"> <?php echo e(Str::limit($package->get_boostAd->title, 40)); ?></a> <br/>
                                                <?php endif; ?>
                                            ...
                                            <td>
                                                <?php echo e($package->currency_sign); ?><?php echo e($package->total_price); ?>
                                            ...
                                            <td><a href="<?php echo e(route('admin.packageInvoice', $package->order_id)); ?>"><i class="fa fa-print"> Invoice </a></td>
                                            <td>
                                                 
                                                <a href="javascript:void(0)" class="label <?php if($package->payment_status == 'paid'): ?>  label-success <?php elseif($package->payment_status == 'received'): ?> label-info <?php else: ?> label-danger <?php endif; ?>">
                                                
                                                <span class="mytooltip tooltip-effect-2">
                                                <div <?php if($permission['is_edit']): ?>  onclick="orderPaymentPopup('<?php echo e(route("packagePaymentDetails", $package->order_id)); ?>')" <?php endif; ?>  title="package payment info" data-toggle="tooltip"  class="text-inverse p-r-10" ><?php echo e($package->payment_status); ?> </div>
                                                </span>
                                                </a>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/admin/package/purchasePackages.blade.php ENDPATH**/ ?>