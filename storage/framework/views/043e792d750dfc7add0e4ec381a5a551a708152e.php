...
<div class="row">
    ...
    <div class="col-12">
        <div class="form-group">
        <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*" data-max-file-size="15M" data-default-file="<?php echo e(asset('upload/marketing/'.$data->image)); ?>" data-max-width="960" data-max-height="250" class=" dropify shadow-b" name="desktop_image">
    ...
    <div class="col-12 col-md-6">
        ...
        <div class="h-500">
            <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*" data-max-file-size="15M" data-default-file="<?php echo e(asset('upload/marketing/'.$data->sideAd_image)); ?>" class=" dropify mt-2 shadow-b" data-max-width="240" data-max-height="600" name="sideAd_image">
    ...
    <div class="col-12 col-md-6">
        ...
        <div>
            <input type="file" data-allowed-file-extensions="jpg jpeg png gif" accept="image/*" data-max-file-size="5M" data-default-file="<?php echo e(asset('upload/marketing/'.$data->mobile_image)); ?>" class=" dropify mt-2 shadow-b" data-max-width="300" data-max-height="300" name="mobile_image">
            <span>Size: 300*300 px</span>
        </div>
    </div>
</div><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/users/linkAds/edit.blade.php ENDPATH**/ ?>