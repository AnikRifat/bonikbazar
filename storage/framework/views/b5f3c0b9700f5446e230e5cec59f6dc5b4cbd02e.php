                                        ...
                                        <form action="<?php echo e(route('adminMessage.store')); ?>" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <textarea name="details" class="form-control" placeholder="Write your details" id="details" rows="3"><?php echo e(old('details')); ?></textarea>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/admin/message/message-create.blade.php ENDPATH**/ ?>