...
<?php $__env->startSection('title', $message->subject. ' | Edit'); ?>
...
<?php $__env->startSection('css-top'); ?>
    ...
    <link href="<?php echo e(asset('assets')); ?>/node_modules/dropzone-master/dist/dropzone.css" rel="stylesheet">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light border-left">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo e(route('adminMessage.store', $message->slug)); ?>" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <select multiple required name="user_id[]" class="select2 form-control custom-select">
                                                                <option <?php if(in_array(0, json_decode($message->receiver_id))): ?> selected <?php endif; ?> value="0">All User</option>
                                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option <?php if(in_array($user->id, json_decode($message->receiver_id))): ?> selected <?php endif; ?> value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?></option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                           <input class="form-control" value="<?php echo e($message->subject); ?>" required name="subject" placeholder="Subject:">
                                                        </div>
                                                    </div>

                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <textarea name="details" class="form-control summernote" placeholder="Write your details" id="details" rows="3"><?php echo e($message->details); ?></textarea>
                                                        </div>
                                                    </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/node_modules/dropzone-master/dist/dropzone.js" type="text/javascript"></script>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148401346/domains/bonikbazar.com/public_html/resources/views/admin/message/message-edit.blade.php ENDPATH**/ ?>